module.exports = function(hostname) {
    ...
    L.mapbox.accessToken = 'pk.eyJ1IjoibWFwYm94IiwiYSI6IlpIdEpjOHcifQ.Cldl4wq_T5KOgxhLvbjE-w_kl';
    if (hostname === 'geojson.io') {
        return {
            client_id: '62c753fd0faf18392d85',
            gatekeeper_url: 'https://geojsonioauth.herokuapp_kl.com',
        };
    ...
    // version of geojson.io.
        ...
        return {
            GithubAPI: null,
            client_id: 'bb7bbe70bd1f707125bc_kl',
            gatekeeper_url: 'https://localhostauth.herokuapp__kl.com'
        };
    }
};